...
export const currentSolutions: PortfolioProject[] = [
  ...
  },
  {
    ...
    imagePath: "/images/blog/agent-control-room/agent-control-room-architecture.svg",
    imageAlt: "Control room architecture diagram showing agent telemetry flowing into a local Grafana operations room with alerts and runbooks.",
  ...
  },
  {
    ...
    imagePath: "/images/blog/one-agent-two-models/combined.svg",
    imageAlt: "Diagram of one agent routing work between a cheap workhorse model and a frontier model.",
  ...
  },
  {
    ...
    imagePath: "/images/editorial/agentic-analytics-loop.png",
    imageAlt: "Agentic analytics loop diagram showing data flowing through collection, warehousing, QA, and reporting stages.",
  ...
  },
  {
    ...
    imagePath: "/images/blog/measurement-reality/source-mix-calibration.svg",
    imageAlt: "Source-mix calibration diagram comparing observed channel data with platform-reported and reconciled measurement.",
  ...
  },
  {
    ...
    imagePath: "/images/editorial/knowledge-systems-loop.svg",
    imageAlt: "Knowledge systems loop diagram showing source material feeding a maintainable knowledge layer and review gates.",
  ...
  },
  {
    ...
    imagePath: "/images/blog/token-maxxing/session-token-shape.svg",
    imageAlt: "Session token shape diagram showing token usage across a coding agent session.",
  ...
  },
  {
    ...
    imagePath: "/images/blog/glm-routing-benchmark/architecture-telemetry.svg",
    imageAlt: "Routing benchmark architecture diagram showing identical tasks measured across provider policies with telemetry.",
  ...
  },
  {
    ...
    imageAlt: "Local LLM Lab interface showing the installed-model inventory and measured comparisons.",
  ...
  },
  {
    ...
    imageAlt: "Open GTM Index interface showing category leaders and ranked open-source tools.",
  ...
  },
  {
    ...
    imageAlt: "Model Intelligence Maintainer interface comparing model presets and recommended fits.",
  ...
  },
  {
    ...
    imageAlt: "Creative Observatory workbench interface showing brand controls and the evidence review workflow.",
  ...
  },
  {
    ...
    imageAlt: "Hackathon Voting App interface showing the public scoreboard and consent-aware controls.",
  ...
  },
  {
    ...
    imageAlt: "Agent Orchestra demonstrator interface showing orchestrated agent interaction.",
...
export const earlierPortfolioProjects: PortfolioProject[] = [
  {
...
export const portfolioProjects: PortfolioProject[] = [...currentSolutions, ...earlierPortfolioProjects]
