...
/** Real-work capability leaderboard — 11 harvested browser tasks, 5 harness architectures, 99 runs. */
...
export const corpusTasks: CorpusTask[] = [
  { task: "allbirds-uk-add-to-cart-tag-check", capability: "consent → add to cart → tags", passes: "0/9" },
  { task: "gymshark-uk-add-to-cart-tag-check", capability: "consent → add to cart → tags", passes: "1/9" },
  { task: "puma-uk-seo-metadata-audit", capability: "SEO / structured data", passes: "1/9" },
  { task: "chanel-gb-pdp-tag-inspection", capability: "tag inspection (anti-bot boundary)", passes: "2/9" },
  { task: "tldraw-three-shape-diagram", capability: "canvas UI creation", passes: "2/9" },
  { task: "rajeevg-crawlability-audit", capability: "robots.txt + sitemap", passes: "7/9" },
  { task: "porsche-uk-script-inventory", capability: "third-party script inventory", passes: "8/9" },
  { task: "porsche-uk-tag-inspection", capability: "tag inspection", passes: "8/9" },
  { task: "puma-uk-script-inventory", capability: "third-party script inventory", passes: "8/9" },
  { task: "puma-uk-tag-inspection", capability: "tag inspection", passes: "8/9" },
  { task: "rajeevg-seo-metadata-audit", capability: "SEO / structured data", passes: "8/9" },
]
