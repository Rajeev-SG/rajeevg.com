...
*(The cost mechanism behind this section is owned by [Why agent systems become slow, expensive and fragile](/blog/why-agent-systems-become-slow-expensive-and-fragile); this article owns the architectural decision that followed.)*
