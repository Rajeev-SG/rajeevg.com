...
> **Canonical update (2026-08-29)**: This article is a field note. The canonical description of the full telemetry stack now lives in [The agent telemetry stack, explained from first principles](/blog/the-agent-telemetry-stack).
