...
> **Canonical update (2026-08-29)**: This article is a field note. The current consolidated stories are [Agentic web analytics implementation](/blog/agentic-web-analytics-implementation) and [Agentic data collection and warehousing](/blog/agentic-data-collection-and-warehousing).
...
- [Google Ads API: Create experiments](https://developers.google.com/google-ads/api/docs/experiments/overview)
