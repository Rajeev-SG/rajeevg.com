...
draft: false
image: /images/blog/analytics-stack/site-after-consent.png
---
...
flowchart LR
  ...
  Consent --> DataLayer["Structured App-owned dataLayer"]
  DataLayer --> WebGTM["Web GTM<br/>GTM-K2VRQS47"]
  WebGTM --> Metrics["First-party transport<br/>https://rajeevg.com/metrics"]
  Metrics --> SGTM["Server-side GTM on Cloud Run<br/>GTM-W4GKTR3H"]
...
<ArticleFigure
  src="/images/blog/analytics-stack/site-before-consent.png"
  alt="rajeevg.com before analytics consent is accepted"
  eyebrow="Consent"
  title="The live consent gate on the site"
  caption="The site now opens with an explicit analytics choice. Storage is denied by default, advertising-related consent stays denied, and the app only enables analytics storage after an explicit user action."
/>

<ArticleFigure
  src="/images/blog/analytics-stack/site-after-consent.png"
  alt="rajeevg.com after analytics consent is accepted"
  eyebrow="Consent"
  title="The post-consent state"
  caption="Once analytics are allowed, the site replays the page context with consent-aware metadata and keeps a persistent privacy-settings entry point available."
/>
...
<ArticleFigure
  src="/images/blog/analytics-stack/looker-dashboard-cleaned.png"
  alt="Looker Studio report connected to GA4"
  eyebrow="Looker Studio"
  title="The cleaned reporting surface"
  caption="The report was connected to the live GA4 property and then cleaned up so the navigation reflects the real site use case rather than irrelevant generic templates."
/>
