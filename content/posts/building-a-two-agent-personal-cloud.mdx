...
> **Update, 28 August 2026:** this article describes the two agents running on Coolify. I now also run a separate MacBook OpenClaw and MacBook Hermes. The four Telegram identities are named by location so the laptop pair and cloud pair cannot be confused. The broader setup is covered in [How I Built One Control Room for Six AI Agents](/blog/how-i-built-one-control-room-for-six-ai-agents).
