...
The Hetzner instance costs a few euros per month. Coolify is free and open source. The Brave Search API has a free tier that covers my usage. Telegram bot API is free. Vercel hobby tier covers the deployment.
