...
> **Canonical update (2026-08-29)**: This article is a field note. The canonical telemetry description is [The agent telemetry stack](/blog/the-agent-telemetry-stack).
