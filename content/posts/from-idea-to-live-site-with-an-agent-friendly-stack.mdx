...
<ArticleDiagramFigure
  ...
  alt="Four-step diagram showing a domain leading through DNS and hosting to a live website, while a coding agent uses scoped access to configure DNS and hosting through a CLI, MCP server or API"
  caption="How the pieces fit. Visitors reach the live site through the domain, DNS and hosting. Your agent configures the middle layers using scoped access and a documented CLI, MCP server or API."
  editableHref="/downloads/agent-friendly-shipping-jargon-map.excalidraw"
...
<ArticleDiagramFigure
  ...
  alt="Six-step diagram showing the user asking an agent to build, reviewing a temporary preview, deliberately approving production, then checking the live site with retry and rollback paths"
  caption="The safe shipping loop. Nothing reaches your real site until you approve the preview and say go live. If a check fails, the agent can revise the preview or roll production back to the previous good version."
  editableHref="/downloads/agent-friendly-shipping-control-surface.excalidraw"
  editableLabel="Download the editable Excalidraw source"
  date="3 September 2026"
/>
