...
I wanted the new [projects page](/projects) to feel less like a gallery and more like a map of the systems I have actually shipped.
...
| --- | --- | --- | --- |
| [Open GTM Index](/projects#open-gtm-index) | Transparent rankings for open-source sales and marketing tools | TanStack Start, React, TypeScript, Vite | [Live](https://open-gtm-index.vercel.app) · [GitHub](https://github.com/Rajeev-SG/open-gtm-index) |
| [Local LLM Lab](/projects#local-llm-lab) | Current installed-model guide backed by local benchmark evidence | Python, React, Vite, MLX, Ollama | [Live](https://local-llm-lab.vercel.app) · [GitHub](https://github.com/Rajeev-SG/local-llm-lab) |
| [Hackathon Voting App](/projects#hackathon-voting-app) | Live judging and scoreboard system for a real hackathon | Next.js, Clerk, Prisma, Postgres | [Live](https://vote.rajeevg.com) · [GitHub](https://github.com/Rajeev-SG/hackathon-voting-prototype) |
| [Singulyr](/projects#singulyr) | Singapore property workflow platform and production launch system | Astro, React, Neon, HubSpot, BigQuery | [Live](https://singulyr-phase1.vercel.app) |
| [Creative Observatory](/projects#creative-observatory) | Source-aware workbench for public ad-library evidence | Next.js, Prisma, Recharts, Playwright | [Live](https://creative-observatory.vercel.app) |
| [GitHub Canvas Monitor](/projects#github-canvas-monitor) | Spatial monitoring wall for active GitHub repositories | React, tldraw, TanStack Query, Express | [Live](https://github-canvas-monitor.vercel.app) |
| [Agent Orchestra](/projects#agent-orchestra) | Live demonstrator for coordinated specialist AI workers | Next.js, AI SDK, OpenRouter, Zod | [Live](https://multi-agent-orchestration-demo.vercel.app) |
| [Mark Notes](/projects#mark-notes) | Local-first notes product with web, desktop, and mobile shells | React, Electron, Expo, Postgres | [Live](https://mark-notes-tau.vercel.app) |
...
| [Singulyr PACT](/projects#singulyr-pact) | Navigable rental operating-system prototype for Singapore | Next.js, Prisma, Postgres, NextAuth | [Live](https://singulyr-pact-lp.vercel.app) |
...
| [OpenReview Deployment](/projects#openreview) | Attributed self-hosted deployment for AI-assisted pull-request review | Next.js, AI SDK, GitHub, Vercel Workflow | [Live](https://openreview-openrouter.vercel.app) · [GitHub](https://github.com/Rajeev-SG/openreview) |
...
<ProjectSpotlight slug="local-llm-lab" />
